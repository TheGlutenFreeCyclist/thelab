  ...
  <div class="wrap">
    <div class="top-bar">
      ...
      <div class="top-actions">
        <span class="live-pill">Live · Europe/Rome</span>
        <a class="logout-link" href="{{ url_for('logout') }}">Log out</a>
      </div>
    </div>
    <div class="header-center home-hero">
      <img class="home-logo" src="data:image/png;base64,{{ logo }}" alt="The Gluten Free Cyclist">
      <h1 class="page-title">Health Snapshot</h1>
      <div class="hero-script">Your daily training desk</div>
      <p class="subtitle">Last {{ days }} days for recovery &middot; {{ season_days }} days for training context &middot; Intervals.icu + AI coach</p>
    </div>
    ...
    <div class="control-deck no-print">
      <section class="control-card chat-section">
        ...
        <p class="subtitle">Tell the coach anything that should change today's interpretation or the next sessions.</p>
        <form method="post" action="{{ url_for('ask') }}" id="chat-form" class="control-chat-form">
          <input type="text" class="chat-input" name="question" placeholder="e.g. Legs feel unusually heavy today" required>
      ...
      <section class="control-card checkin-card">
        ...
        <p class="subtitle">How do you feel right now? Your own signal sits beside the wearable data.</p>
        <div class="checkin-row">
          ...
          <form method="post" action="{{ url_for('log_feeling') }}" class="checkin-buttons">
            {% for n in range(1, 11) %}<button type="submit" name="feeling" value="{{ n }}" class="checkin-btn display">{{ n }}</button>{% endfor %}
          </form>
        </div>
        <div class="checkin-scale"><span>1 · Terrible</span><span>5–6 · Neutral</span><span>10 · Amazing</span></div>
      </section>
      ...
      <section class="control-card snapshot-card" id="snapshot-card">
        ...
        <div class="snapshot-status-box">
          ...
          <div class="snapshot-status-copy" id="snapshot-status-copy">Pull fresh Intervals.icu data, then let the coach decide what comes next.</div>
          <div class="coach-clock-preview">
            <span class="clock-mini-label display">COACH CLOCK</span>
