...
APP_VERSION = "THE LAB · COACH CLOCK v3.0"
...
.coach-clock-preview strong { font-family:'Bayon',sans-serif; font-size: 23px; text-align:center; }
...
.clock-live { font-family:'Bayon',sans-serif; font-size:47px; line-height:.9; letter-spacing:.03em; }
...
.clock-copy h3 { margin:0; font-family:'Bayon',sans-serif; font-size:31px; letter-spacing:.03em; font-weight:400; }
...
.slot-status strong { display:block; margin-top:4px; font-family:'Bayon',sans-serif; font-size:22px; font-weight:400; }
...
.next-slot-ribbon strong { font-family:'Bayon',sans-serif; font-size:20px; font-weight:400; color:var(--orange); text-align:right; }
...
.readiness-ring-score { font-family:'Bayon',sans-serif; font-size:34px; line-height:.9; }
...
.coach-call-title { font-family:'Bayon',sans-serif; font-size:30px; margin:4px 0 7px; }
...
.session-title { font-family:'Bayon',sans-serif; font-size:25px; line-height:1.05; margin:7px 0 9px; }
  ...
  <div class="wrap">
    ...
    <div class="section dashboard-section">
      ...
      <div class="coach-clock-card">
        ...
        <div class="clock-copy">
          <div class="coach-call-kicker">COACH CLOCK · EUROPE/ROME</div>
    ...
    <div class="next-sessions-section">
      <div class="next-sessions-head">
        ...
        <p>Built from the snapshot time and today's activities already logged on Intervals.icu.</p>
      </div>
...
def ask_claude(data_text, metrics, coach_clock):
    now = get_rome_now()
    slot_lines = "\n".join(
...
def analyze():
    ...
    try:
        ...
        analysis = ask_claude(data_text, metrics, coach_clock)
        data = {
