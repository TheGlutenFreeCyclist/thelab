...
APP_VERSION = "THE LAB · V7 · ENERGY 2.0 · DEDUP · PWA · WEEK MEMORY"
  ...
  <main class="v4-shell">
    ...
    <section class="v4-dashboard">
      ...
      <details class="v4-card v4-section-card v7-analysis" open>
        <summary><div><h2 class="v4-section-title">Training</h2><p class="v4-section-note">Last {{ days }} days</p></div><span class="v7-analysis-toggle">+</span></summary>
      ...
      <details class="v4-card v4-section-card v7-analysis" open>
        <summary><div><h2 class="v4-section-title">Health</h2><p class="v4-section-note">Most recent readings</p></div><span class="v7-analysis-toggle">+</span></summary>
        <div class="v7-analysis-body">
      ...
      <details class="v4-card v4-section-card v7-analysis" open>
        <summary><div><h2 class="v4-section-title">Power Curve</h2><p class="v4-section-note">Best efforts · last 42 days</p></div><span class="v7-analysis-toggle">+</span></summary>
        <div class="v7-analysis-body">
      ...
      <details class="v4-card v4-section-card v7-analysis" open>
        <summary><div><h2 class="v4-section-title">Season</h2><p class="v4-section-note">Last {{ season_days }} days</p></div><span class="v7-analysis-toggle">+</span></summary>
        <div class="v7-analysis-body">
...
def compute_energy_bank(form_zone, fatigue_zone, avg_sleep_hours, recent_activities=None, personal_baselines=None, now=None):
    ...
    duration and session type. This is intentionally different from Race
    Readiness: an athlete can still be broadly race-ready while having used a
    large share of today's available energy by the evening.
    """
    now = now or get_rome_now()
    recent_activities = recent_activities or []
    pb = personal_baselines or {}

    # Morning potential: conservative enough that 100 is genuinely exceptional.
    morning = 62
    ...
    if sleep.get("color") == "red": morning -= 7
    elif sleep.get("color") == "grey": morning -= 3
    ...
    # Training cost: load does most of the work; duration, double-days and
    # quality sessions add smaller penalties. Cap prevents pathological values.
...
def compute_race_readiness(form_zone, fatigue_zone, sleep_quality, personal_baselines):
    ...
    if sleep_quality == 1:
        ...
        score -= 4; signals.append((2, "sleep quality average"))
    ...
    if sleep.get("color") == "green": score += 5
...
def build_preview_data():
    ...
    energy = compute_energy_bank("green", "grey", 7.6, recent_activities=sample_activities, personal_baselines=pb, now=now)
    return {
        **energy,
