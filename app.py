...
APP_VERSION = "THE LAB · HOME POLISH v3.4 · WEEK MEMORY"
...
.polar-center { position:relative; z-index:1; text-align:center; font-family:'Parkinsans',sans-serif; font-size:22px; }
.polar-center small { display:block; font-family:'Manrope',sans-serif; font-size:9px; color:var(--grey-zone); letter-spacing:.08em; }
...
.hero-script {
  ...
  color:var(--red); margin-top:10px; font-weight:700;
}
...
.control-card .subtitle {
  color:#aeb4bd; font-size:12.5px; line-height:1.55; margin:0 0 18px;
  min-height:39px;
}
    ...
    <div class="section dashboard-section">
      ...
      <div class="coach-clock-card">
        ...
        <div class="clock-copy">
          <div class="coach-call-kicker">COACH CLOCK · EUROPE/ROME · HOME POLISH v3.4</div>
